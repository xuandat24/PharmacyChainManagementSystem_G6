...
class CashShiftServiceTest {
    ...
    // FIX: CashShiftServiceImpl nay doc nguong chenh lech tu SystemSettingService thay vi
    // hardcode — can mock va stub gia tri tra ve (BigDecimal la object nen mock mac dinh
    // tra ve null neu khong stub, se gay NullPointerException khi compareTo).
