 ...
 *
 * FIX: bổ sung mock periodClosingService/auditLogService — GoodsReceiptServiceImpl nay có
 * kiểm tra kỳ khóa (isDateLocked trả về boolean, mặc định false nếu không stub, nên các test
 * hiện có không cần thay đổi hành vi) và ghi audit log (void, không cần stub).
 */
