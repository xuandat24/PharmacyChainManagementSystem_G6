...
class SaleServiceTest {
    ...
    class CompleteSale {
        ...
        @Test
        @DisplayName("completeSale - status doi sang COMPLETED, kho bi tru")
        void completeSale_statusCompleted_inventoryDeducted() {
            ...
            when(inventoryBatchRepository.save(any())).thenAnswer(inv -> {
                ...
                assertThat(b.getQuantityOnHand()).isEqualTo(90); // 100 - 10
                return b;
            });
            ...
            verify(inventoryBatchRepository).save(any());
        }
    }
